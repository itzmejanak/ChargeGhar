...
@router.register(r"auth/google/login", name="auth-google-login")
@extend_schema(
    tags=["Authentication"],
...
@router.register(r"auth/apple/login", name="auth-apple-login")
@extend_schema(
    tags=["Authentication"],
...
@router.register(r"auth/social/error", name="auth-social-error")
@extend_schema(
    tags=["Authentication"],
